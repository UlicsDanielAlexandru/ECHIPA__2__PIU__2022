...
class ButtonsFragment(var clickListener1: android.view.View.OnClickListener,
    ...
    override fun onCreateView(
        ...
        screen13 = view.findViewById(R.id.screen13)
        screen14 = view.findViewById(R.id.screen14)
        screen15 = view.findViewById(R.id.screen15)
        screen16 = view.findViewById(R.id.screen16)
        screen17 = view.findViewById(R.id.screen17)
        screen18 = view.findViewById(R.id.screen18)
        screen19 = view.findViewById(R.id.screen19)
        ...
        screen13.setOnClickListener(clickListener13)
        screen14.setOnClickListener(clickListener14)
        screen15.setOnClickListener(clickListener15)
        screen16.setOnClickListener(clickListener16)
        screen17.setOnClickListener(clickListener17)
        screen18.setOnClickListener(clickListener18)
        screen19.setOnClickListener(clickListener19)
